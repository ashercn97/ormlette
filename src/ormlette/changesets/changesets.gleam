...
// Example validators using the core validation library
pub fn string_is_not_empty(error: a) -> valid.Validator(String, String, a) {
  fn(value: String) {
...
pub fn int_min(min: Int, error: a) -> valid.Validator(Int, Int, a) {
  fn(value: Int) {
    case value < min {
      True -> Error(non_empty_list.new(error, []))
      False -> Ok(value)
...
pub fn string_is_email(error: a) -> valid.Validator(String, String, a) {
  fn(value: String) {
