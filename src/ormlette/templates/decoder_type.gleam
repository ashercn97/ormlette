...
pub fn ",
    ...
    |> decode.field(\"",
          ...
          let builder =
            string_builder.append(builder, to_string.decode_type(col))
          let builder =
            string_builder.append(
              builder,
              "))
            ...
            let builder =
              list.fold(
                ...
                fn(builder, col_stuff) {
                  let builder =
                    string_builder.append(builder, { col_stuff.0 }.name)
                  let builder = string_builder.append(builder, "_")
                  let builder =
                    string_builder.append(
                      builder,
...
pub fn ",
    ...
    decode.into({
      ...
      use ",
                  ...
                  let builder = string_builder.append(builder, "_")
                  let builder =
                    string_builder.append(builder, col_info.reference_table)
                  let builder =
                    string_builder.append(
                      builder,
                      " <- decode.parameter
    ...
    |> decode.field(\"",
                  ...
                  let builder =
                    string_builder.append(builder, "\", decode.optional(")
                  let builder =
                    string_builder.append(
                      builder,
