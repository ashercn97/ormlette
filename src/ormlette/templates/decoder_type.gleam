...
pub fn ")
    ...
    let builder = string_builder.append(builder, to_string.decode_type(col))
    let builder = string_builder.append(builder, "))
    ")
...
pub type ")
  ...
  ")
    ...
    let builder = string_builder.append(builder, "(
    ")
    let builder = list.fold(list.zip(combine.get_column_info(combined_table), combined_table.columns), builder, fn(builder, col_stuff) {
            let builder = string_builder.append(builder, col_stuff.0.name)
    let builder = string_builder.append(builder, "_")
    let builder = string_builder.append(builder, col_stuff.0.reference_table)
    let builder = string_builder.append(builder, ": Option(")
    let builder = string_builder.append(builder, to_string.coltype(col_stuff.1))
    let builder = string_builder.append(builder, "), ")
...
pub fn ")
    let builder = string_builder.append(builder, combined_table.name)
    let builder = string_builder.append(builder, "_decoder() {
    decode.into({
      ")
    ...
    let builder = string_builder.append(builder, col_stuff.0.reference_table)
    let builder = string_builder.append(builder, "\", decode.optional(")
    let builder = string_builder.append(builder, to_string.decode_type(col_stuff.1))
    let builder = string_builder.append(builder, "))
    ")
